...
if [[ $# -ne 0 ]]; then
  cat >&2 <<'USAGE'
Usage: ./scripts/build-podman-deb-debian-trixie.sh
...
PATCH_SOURCE_DIR="${REPO_ROOT}/packaging/patches-debian-trixie"
DOCKERFILE_PATH="docker/Dockerfile.debian-trixie"
